  ...
  \begin{lemma}\label{lem:no multiple complex factors}
    ...
    \begin{theorem}[Improved \cref{thm:subproblem reduction}]\label{thm:improved subproblem reduction}
      ...
      \begin{proof}
        ...
        Lorentz factors everywhere. Brute-force enumeration of the
        partitions of $\dim\of{K}$ and $n + \dim\of{K}$ for all valid
        pairs of $\pair{n}{\dim\of{K}}$ suffices to check the
        remaining cases.
      \end{proof}
    \end{theorem}
  \end{section}
