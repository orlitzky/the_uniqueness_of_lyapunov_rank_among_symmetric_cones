      ...
      \begin{proof}
        ...
        \begin{pcases}
          \begin{case}[$n_{1} \le \dim\of{K}$]
            ...
            \cref{lem:more conditions} we have that $n > \dim\of{K}$,
            ...
            $n_{\smallestidx} \le \dim\of{K}$. Thus by \cref{lem:more
              conditions}, $\dim\of{K} + 1 + \delta < n$, which is
            what we need to replace $S\of{\smallestidx}$ by $\delta$
            and apply \cref{impl:growth inequality for f pt2}. Doing
            so,
            %
            \begin{align*}
              \sum_{i=1}^{k}f\of{n_{i}}
