  ...
  \begin{lemma}\label{lem:no multiple complex factors}
    ...
    \begin{conjecture}\label{conj:subproblem reduction}
      ...
      \begin{proof}
        ...
        has no $\Hnplus[3]$ factor. The resulting scenario follows
        closely that of \cref{prop:no similacra for h3plus and big
          enough lnplus}, with the new bounds on $n$ supplied by
