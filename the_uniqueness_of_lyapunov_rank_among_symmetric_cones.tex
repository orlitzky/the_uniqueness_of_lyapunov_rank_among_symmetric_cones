...
\begin{document}
  ...
  \begin{section}{Reducible cones}\label{sec:reducible cones}
    ...
    $\directsum{\Lnplus}{K}$ to that for $K$.

    When the problem is to find similacra of $\directsum{\Lnplus}{K}$,
    ...
    \begin{theorem}[Improved \cref{thm:subproblem reduction}]\label{thm:improved subproblem reduction}
      ...
      \directsum{\Lnplus}{K}$ if and only if there exists a symmetric
      $J'$ such that $J \cong \directsum{\Lnplus}{J'}$ and $J' \sim
      K$.
      ...
      \begin{proof}
        ...
        Recall that $\lyapunovrank{\directsum{\Lnplus}{K}} \ge
        ...
        \directsum{\Lnplus}{K}$ for all generated $K$ and $J$.
      \end{proof}
    \end{theorem}
    ...
    \begin{equation*}
      \directsum{K}{\Lnplus}
      \sim
      \directsum{\Lnplus[n+1]}{\Rnplus[\dim\of{K}-1]}.
    \end{equation*}
    %
    ...
    \begin{corollary}\label{cor:HC(3)+L(n)}
      ...
      $\directsum{\Lnplus}{K}$ has no symmetric similacra. In
