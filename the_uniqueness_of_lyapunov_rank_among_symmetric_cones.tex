...
\begin{document}
  ...
  \begin{lemma}\label{lem:no multiple complex factors}
    ...
    \begin{proposition}
      ...
      $\directsum{\Lnplus[m]}{\Lnplus}$ has no symmetric similacra.
      %
      \begin{proof}
        ...
        \begin{itemize}
          ...
          \end{item}
          \begin{item}
            $m = 3$ and $n = 4$, which satisfies neither
          ...
          \end{item}
          \begin{item}
            $m = 2$, where we have the counterexample
            $\directsum{\Rnplus[2]}{\Lnplus[4]} \sim
            \Hnplus[3]\of{\Rn[1]}$.
          \end{item}
          \begin{item}
            $m = 1$, where none of $n \in \set{2,3,4,5}$ give
            similacra.
          \end{item}
          \begin{item}
